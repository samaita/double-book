...
**By forcing it into a queue with Message Queue**

This will be done during ATC process, to prevent people doing ATC if the stock is empty. It doesn't make sense if user able to to ATC a product that already empty, right?
...
![e-commerce basic diagram](https://1.bp.blogspot.com/-LwBNFb-b8UM/YVtLQaV2bLI/AAAAAAAATBw/2N2GKNdl4mo6vDFNxua2SNYjk4zRkkdXQCLcBGAsYHQ/s16000/Evermos%2BE-Commerce%2BDiagram.png "Database Design")
...
- `Stock Detail` contain information about who is claim the stock.
